...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($senha !== $confirmar) {
    header("Location: ../html/cad_aluno.php?erro=As senhas não coincidem!");
    exit();
        }
        ...
        $stmt = $pdo->prepare("INSERT INTO tb_aluno
            (nm_aluno, dt_nascimento, ds_email, nm_senha_hash, nr_telefone, id_genero) 
            VALUES 
...
header("Location: ../html/login_aluno.php");
        exit();
    }
