...
<body>
    ...
    <div class="perfil-container">
        ...
        <div style="text-align:center; margin-bottom:20px;">
            ...
            <br>
            <input type="file" id="inputFoto" name="profile_image" form="perfilForm" accept="image/*" style="margin-top:10px;" >
        </div>
    <form id="perfilForm" method="post" action="../php/updateperfil.php" enctype="multipart/form-data">
